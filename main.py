...
from textual.widgets import Header, Footer, DataTable, Static, Button, Input, Label, Select
...
class AddModal(ModalScreen):
    ...
    def compose(self) -> ComposeResult:
        with Container(id="modal-dialog"):
            ...
            yield Select(DIFFICULTY_OPTIONS, prompt="Select Difficulty", id="difficulty")
            yield Label("Topic:")
...
class RecallApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="main-container"):
            ...
            with Vertical(id="left-pane"):
                ...
                yield SearchInput(placeholder="Search problems...", id="search_box", classes="search-box")
    ...
    def refresh_data(self) -> None:
        ...
        filtered_problems = [
            p for p in problems 
            if self.search_filter.lower() in p["title"].lower() or self.search_filter.lower() in p.get("topic", "").lower()
        ]
        ...
        for p in filtered_problems:
            ...
            if self.show_stats:
                ...
                diff_display = SHORT_DIFF.get(p["difficulty"], p["difficulty"][0] if p["difficulty"] else "?")
            else:
            ...
            table.add_row(p["title"], diff_display, topic_display, progress, last_col)
    ...
    def action_add_problem(self) -> None:
        def check_submit(submitted: bool):
            if submitted: self.refresh_data()
    ...
    def action_open_url(self) -> None:
        ...
        if problem and problem.get("url"):
            ...
            self.notify(f"Opening {problem['title']}...")
        else:
